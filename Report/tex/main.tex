...
Из графиков видно, что ошибки практически совпадают даже при маленьких $L$ и $N$. Но в крайних точках заметно расхождение.
...
Численные результаты показывают, что для случая зашумленных гармоник первый порядок адекватно оценивает полную ошибку восстановления сигнала в каждой точке при любых рассматриваемых параметрах сигналов, хотя на краях заметно расхождение (разность ошибок существенно медленнее стремится к нулю).
